...
class Vacancy(models.Model):
    ...
    responsibilities = models.ManyToManyField('Responsibilities', blank=True, null=True, verbose_name='Обязанности')
    requirements = models.ManyToManyField('Requirements', blank=True, null=True, verbose_name='Требования')
    conditions = models.ManyToManyField('Conditions', blank=True, null=True, verbose_name='Условия')
